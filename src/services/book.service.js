            ...
            const bookGroup = await db.BookGroup.create(
                {
                    ...
                    borrowFeeApplied: newBook.borrowFeeApplied,
                    slug: newBook.slug,
            ...
            await db.BookGroup.update(
                {
                    ...
                    borrowFeeApplied: updateBookGroup.borrowFeeApplied,
        ...
        const { rows, count } = await db.Book.findAndCountAll({
            ...
            include: [
                ...
                },
                {
                    ...
                    required: false,
                    attributes: ["id"],
                    where: { ...whereCondition, type: { [Op.in]: [LOAN_STATUS.BORROWING, LOAN_STATUS.LOST] } },
                    required: false,
                    limit: 1,
                },
            ],
